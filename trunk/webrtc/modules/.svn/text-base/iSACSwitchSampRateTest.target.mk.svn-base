...
$(builddir)/iSACSwitchSampRateTest: LD_INPUTS := $(OBJS) $(obj).target/webrtc/modules/libiSAC.a $(obj).target/webrtc/common_audio/libsignal_processing.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a
$(builddir)/iSACSwitchSampRateTest: TOOLSET := $(TOOLSET)
$(builddir)/iSACSwitchSampRateTest: $(OBJS) $(obj).target/webrtc/modules/libiSAC.a $(obj).target/webrtc/common_audio/libsignal_processing.a $(obj).target/webrtc/system_wrappers/source/libsystem_wrappers.a FORCE_DO_CMD
	$(call do_cmd,link)
